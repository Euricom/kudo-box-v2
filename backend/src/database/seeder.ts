...
export class Seeder implements OnApplicationBootstrap {
    ...
    private async seedDatabase(): Promise<void> {
        ...
        const tim = new User('faa39cc2-eb5a-4f1f-b7a3-c8335b773742', 'Tim', [event1], undefined, undefined);
        event1.host = tim;
        event3.host = tim;

        const lennert = new User('5a5dd307-0831-4fa6-a082-152713669da1', 'Lennert', [event2], undefined, undefined);
        event2.host = lennert;
