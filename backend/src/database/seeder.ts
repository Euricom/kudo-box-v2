...
export class Seeder implements OnApplicationBootstrap {
    ...
    private async seedDatabase(): Promise<void> {
        ...
        const event1 = new Event('7a73e957-45ad-445d-b9f8-ebd6e2807f85', 'Verjaardag Jos', true, new Date(), 'https://ekudos.blob.core.windows.net/ekudo-dev/event-50660c35-fefb-46c3-a3f2-8afd83d53ec1.jpeg', tag1, [], [], undefined, undefined, undefined);

        const tag2 = new Tag('cb4b49da-7c34-4313-91b1-d263516b013a', 'R-101', undefined)
        const event2 = new Event('f14c73cd-133b-4944-af3a-883de2962267', 'React 101', true, new Date(), 'https://ekudos.blob.core.windows.net/ekudo-dev/event-a52f05d0-ab85-41ea-ac42-2221c2e257f3.png', tag2, [], [], undefined, undefined, undefined);

        const tag3 = new Tag('b09c065a-e279-46b6-9fd5-f8343a75ad82', 'A&R', undefined)
        const event3 = new Event('3ada5d42-03dc-4a9d-9e6e-964be1b0306d', 'Angular & Rxjs', true, new Date(), 'https://ekudos.blob.core.windows.net/ekudo-dev/event-1191627f-b2f3-4f8c-b291-c549c45e219b.png', tag3, [], [], undefined, undefined, undefined);

        const tag4 = new Tag('6ff6111f-b92b-41bf-83f0-b7c67f14b105', 'EFC', undefined);
        const event4 = new Event('03b994fa-9336-4a6a-86be-6d2796408a59', 'EF Core', false, new Date(), 'https://ekudos.blob.core.windows.net/ekudo-dev/event-a70ab0b9-8905-462c-845d-e4f1c2889e2d.png', tag4, [], [tag3], undefined, event3, []);
